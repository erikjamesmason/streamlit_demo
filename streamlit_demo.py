...
@st.cache
def get_data():
    return pd.read_csv("http://data.insideairbnb.com/united-states/or/portland/2021-09-24/visualisations/listings.csv")

df = get_data()
st.title("Streamlit 101: An in-depth introduction")
st.markdown("Welcome to this in-depth introduction to [Streamlit](www.streamlit.io)! For this exercise, we'll use an Airbnb [dataset](http://data.insideairbnb.com/united-states/or/portland/2021-09-24/visualisations/listings.csv) containing NYC listings.")
st.header("Customary quote")
st.subheader("I don't know who determines this")
